...
class Breadcrumb extends Component
{
    ...
    {
        $this->breadcrumb = $this->bootstrap_breadcrumb();
    }
 ...
 */
    public function custom_get_category_parents($id, $visited = array())
    {
        $chain = '';
